...
print("\n[sigmoid] Унікальні класи y:", np.unique(y, return_counts=True))

X_train, X_test, y_train, y_test = train_test_split(X_encoded, y, test_size=0.2, random_state=5)
print("[sigmoid] Мітки y_train:", np.unique(y_train, return_counts=True))
...
print("\n=== Результат для тестової точки [sigmoid] ===")
